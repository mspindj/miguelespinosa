...
const bio = [
  ...
  "Built design systems at global scale at Teleperformance, leading an extended design community of 30+ designers across practices and disciplines. Before that, scaled the design team from 0 to 12 at BBVA Colombia, led digital transformation for DIRECTV via Globant, and co-founded AI-powered products in fintech and translation.",
  ...
  return (
    <>
      ...
      <section id="manifesto" className="tb-sec" data-tb-section="Manifesto" aria-labelledby="tb-about-man-h" tabIndex={-1}>
        <SecHead idx="01" id="tb-about-man-h" title="Leadership Manifesto" meta="How I Lead" />
      ...
      <section id="contact" className="tb-sec tb-contact" data-tb-section="Contact" aria-labelledby="tb-about-con-h" tabIndex={-1}>
        <SecHead idx="02" id="tb-about-con-h" title="Contact" meta="Get in touch" />

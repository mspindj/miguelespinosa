...
- R2.2 No invented content: no new metrics, clients, testimonials or claims. Approved exceptions (Miguel, 2026-09-24); live figures are dated in the UI, and the historical TP team figure is scoped by its record years (2022–2025): Design Transformation team 0 → 20+ at TP (Miguel's figure); The Birdie Club 180+ paying members (floor of the public `founders-count` edge function, `active: 185` on 2026-09-24) and 2,200+ PDF program buyers with platform access (Miguel's figure); the composed BBVA summary. New microcopy is limited to labels and system UI (record IDs, section labels, status bar), listed in design.md. Launch-snapshot labels drop "still growing", superseded by the dated live figures.
